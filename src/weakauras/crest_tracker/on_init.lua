aura_env.table = {
    ...
    ["rank1"] = { 
        ...
        item = { cost = 30, id = 230937, index = 6 }, --Enchanted Weathered Undermine Crest
    ...
    ["rank3"] = {
        ...
        item = { cost = 45, id = 230936, index = 7 }, --Enchanted Runed Undermine Crest
        achievement = 40944, --Runed of the Undermine
    },
    --Gilded
    ["rank4"] = {
        currency  = { id = 3110, index = 5 }, --Gilded Undermine Crest
        item = { cost = 60, id = 230935, index = 8 }, --Enchanted Gilded Undermine Crest
